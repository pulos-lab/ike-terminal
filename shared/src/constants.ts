export const BENCHMARKS = {
  ...
  wig: { label: 'WIG', stooqTicker: 'wig', yahooTicker: 'WIG.WA', source: 'stooq' as const, currency: 'PLN' },
  wig20: { label: 'WIG20', stooqTicker: 'wig20', yahooTicker: 'WIG20.WA', source: 'stooq' as const, currency: 'PLN' },
  mwig40: { label: 'mWIG40', stooqTicker: 'mwig40', yahooTicker: 'MWIG40.WA', source: 'stooq' as const, currency: 'PLN' },
  swig80: { label: 'sWIG80', stooqTicker: 'swig80', yahooTicker: 'SWIG80.WA', source: 'stooq' as const, currency: 'PLN' },
} as const;
